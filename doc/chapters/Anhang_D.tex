...
\MyCaption{Ergebnis von Versuch 0.}{} \label{img:test_0_OptTf}
\end{center}
\end{figure}
...
\MyCaption{Überprüfung Staudruck \(q\) von Versuch 0.}{} \label{img:test_0_staudruck_OptTf}
\end{center}
\end{figure}
...
\MyCaption{Ergebnis von Versuch 1.}{}\label{img:test_1_OptTf}
\end{center}
\end{figure}
...
\MyCaption{Überprüfung Staudruck \(q\) von Versuch 1.}{}\label{img:test_1_staudruck_OptTf}
\end{center}
\end{figure}