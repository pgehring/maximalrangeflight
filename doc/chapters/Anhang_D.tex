...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth]{../code/Freie_Endzeit_sol/results/test_1_1}
\MyCaption{Versuch 1 - Ergebnis 1}{} \label{img:test_1_1_OptTf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth]{../code/Freie_Endzeit_sol/results/test_1_1_staudruck}
\MyCaption{Überprüfung Staudruck \(q\)}{Untersuchung, ob sich der Staudruck bei Versuch \ref{kap:Versuch01} dem maximalen Staudruck annähert.} \label{img:test_1_1_staudruck_OptTf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth]{../code/Freie_Endzeit_sol/results/test_2_1}
\MyCaption{Versuch 1 - Ergebnis 1}{}\label{img:test_2_1_OptTf}
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=\textwidth]{../code/Freie_Endzeit_sol/results/test_2_1_staudruck}
\MyCaption{Überprüfung Staudruck \(q\)}{Untersuchung, ob sich der Staudruck bei Versuch \ref{kap:Versuch01} dem maximalen Staudruck annähert.}\label{img:test_2_1_staudruck_OptTf}
\end{center}
\end{figure}