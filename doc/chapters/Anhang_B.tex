...
\begin{figure}[htbp]
    ...
    \MyCaption{Lösung des Differentialgleichungsmodells}{Die acht Zustandsgrößen des Vektors wurden mit konstanten Steuerfunktionen \(T\,=\,1259999\,N\) und \(C_L\,=\,1,49\) gelöst.} \label{fig:methods_indirect}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{.9\textwidth}{Zccc}
        ...
        \midrule
        \textit{MATLAB} \texttt{ode45}    &   0,499   &   0,490 \\
        \textit{MATLAB} \texttt{ode23s}   &   0,217   &   0,209 \\
