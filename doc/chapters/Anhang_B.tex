...
\begin{figure}[htbp]
    ...
    \MyCaption{Lösung des Differentialgleichungsmodells}{Die acht Zustandgrößen des Vektors wurden mit kontanten Steuerfunktionen \(T\,=\,1259999\,N\) und \(C_L\,=\,1,49\) gelöst.} \label{fig:methods_indirect}
